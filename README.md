...
On the login page (`/login`), you can use the **1-Click Quick Demo Sign In** buttons or enter the credentials below:

| Role | Email | Password | Target Dashboard Redirection |
| :--- | :--- | :--- | :--- |
| **Admin** | `admin@martpulse.com` | `Admin@12345` | `http://localhost:3000/admin/dashboard` |
| **Store Owner** | `owner@martpulse.com` | `Owner@12345` | `http://localhost:3000/owner/dashboard` |
| **Normal User** | `user@martpulse.com` | `User@12345` | `http://localhost:3000/user/dashboard` |
